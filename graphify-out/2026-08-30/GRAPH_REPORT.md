...
## Corpus Check
- 151 files · ~145,495 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1410 nodes · 2351 edges · 132 communities (82 shown, 50 thin omitted)
...
9. `CashService` - 17 edges
10. `test_pool()` - 17 edges
...
Cohesion: 0.09
Nodes (68): AppState, change_password(), create_user(), get_users(), login(), Option, Result, State (+60 more)
...
Cohesion: 0.07
Nodes (32): CashSession, CloseCashPayload, Expense, OpenCashPayload, OtherIncome, Option, String, UpdateExpensePayload (+24 more)
...
Cohesion: 0.07
Nodes (33): AnularVentaModalProps, ExportFormat, ExportModalProps, formatDateTime(), paymentMethodColor(), paymentMethodLabel(), Sale, SaleDetailModal() (+25 more)
...
Cohesion: 0.13
Nodes (60): AnulacionesBatch, CashBatch, CatalogBatch, InventoryBatch, PurchasesBatch, SalesBatch, apply_anulaciones_batch(), apply_cash_batch() (+52 more)
...
## Knowledge Gaps
- **448 isolated node(s):** `$schema`, `plugin`, `@opencode-ai/plugin`, `name`, `private` (+443 more)
