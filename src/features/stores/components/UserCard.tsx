...
import { User as UserIcon, Mail, Briefcase, Building2, Edit2, Trash2, Unlink } from 'lucide-react';
...
export default function UserCard({ user, stores, isAdmin, onEdit, onDelete, onStoreChange, onUnassign }: UserCardProps) {
    ...
    return (
        ...
        >
                ...
                {isAdmin && (
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            title={user.is_active ? 'Eliminar / dar de baja' : 'Usuario dado de baja'}
                        >
            ...
            <div className="space-y-2">
                ...
                {isAdmin ? (
                    ...
                    <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-100 rounded-lg text-sm text-gray-600">
                        ...
                        {assignedStore ? assignedStore.name : 'Sin asignar'}
                    </div>
                )}
            </div>
            ...
            {showDeleteConfirm && (
                ...
                >
                    <p className="text-sm text-red-800 mb-3">¿Dar de baja este usuario? Ya no podrá iniciar sesión.</p>
                    <div className="flex gap-2">
                        <button
